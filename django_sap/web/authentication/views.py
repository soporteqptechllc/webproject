...
from web.authentication.forms import UserRegistrationForm, UserLoginForm, PasswordResetForm
...
class PagesLoginView(View):
    ...
    def get(self, request):
        if 'username' in request.session:
            return redirect('components_app:tables-viewtabletables1', kword = 1)
            #return redirect('http://192.170.1.251:8000/components/viewtables1/1/')
        else:
